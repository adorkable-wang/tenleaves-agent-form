...
console.debug(DASHSCOPE_API_KEY)
...
export const LLM_TIMEOUT_ENABLED = parseBoolean(process.env.LLM_TIMEOUT_ENABLED, false)
export const LLM_TIMEOUT_MS = parsePositiveNumber(process.env.LLM_TIMEOUT_MS, 20000)
